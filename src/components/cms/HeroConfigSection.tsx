          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
            ...
            <div className="xl:col-span-1">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-3 rounded-lg border border-yellow-200 dark:border-yellow-700/50">
                ...
                <div className="bg-gradient-to-br from-slate-900 to-gray-900 dark:from-slate-800/50 dark:to-gray-800/50 p-3 rounded-lg border border-gray-700 dark:border-gray-600">
                  <div className="flex items-center mb-2">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 p-3 rounded-lg border border-purple-200 dark:border-purple-700/50">
                  <div className="flex items-center mb-2">
                    <div className="bg-white dark:bg-gray-800 rounded-full p-2 mr-3 shadow-sm">
